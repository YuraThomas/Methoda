...
$U_{in_max}  \approx  \frac{Vdd}{K} + U_{G0}$
...
$U_{in_max} = \frac{Vdd}{\sqrt{\frac{k_{1}}{k_{2}}} + 1} + \frac{\sqrt{\frac{k_{1}}{k_{2}}}}{\sqrt{\frac{k_{1}}{k_{2}}} + 1}*\ U_{G0} = \frac{3}{1 + \frac{7}{3}} + \frac{\frac{7}{3}}{1 + \frac{7}{3}}*0.7 = 1.73\ В$
