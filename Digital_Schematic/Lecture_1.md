...
$$I = \ \mu_{n}*C_{ox}*\frac{w}{l}\left( \left( U_{GS} - U_{G0} \right)*U_{DS} - \frac{U_{DS}^{2}}{2} \right) - когда\ транзистор\ \ в\ крутом\ режиме\ (см\ картинку)$$

$$I = \ \mu_{n}*C_{ox}*\frac{w}{2l}*\left( U_{GS} - U_{G0} \right)^{2} - когда\ транзистор\ в\ пологом\ режиме\ (см\ картинку)$$
...
$$A = \frac{10}{2}*\frac{1}{100}\ В = 50\ мВ$$
...
![](images_methoda/media/image8.png){width="2.1515146544181976in"
height="2.3801640419947505in"}
...
$$I = k*\frac{\left( U_{in} - U_{G0} \right)^{2}}{2} = \ k_{n}*\frac{w}{L}*\frac{(50\ мВ\ )^{2}}{2}$$

Если для верхнего транзистора ширина будет равна длине, то тогда:

$$\frac{w}{L} = K^{2} = 100^{2} = 10^{4}$$

$$I = 2*10^{4}*2500*10^{- 6}*\frac{1}{2}\ мА = 25\ мА - довольно\ много,\ греться\ сильно\ будет,\ мб\ даже\ сгорит$$
...
![](images_methoda/media/image9.png){width="5.633979658792651in"
