...
Однако, добавление комбинационной задержки в виде буфера не является единственным (хотя и самым "безопасным" относительно влияния на другие пути) решением проблемы, можно, также уменьшить skew между средним и правым DFF, поменяв задержку по clk у правого DFF с 6ns на 3ns.
