...
В данной статье была разобрана тривиальность как применения регистрового файла, так и его устройства (Д-триггеры и 2 дешифратора), чего, увы, нет в том же Харис-Харисе, что является недоработкой в нем.
