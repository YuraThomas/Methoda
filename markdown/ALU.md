...
Учтем данное условие выражением A[31]&(B[31]) ̅
**Когда A > 0 (знаковый бит = 0), B > 0 (знаковый бит = 0), S < 0 (знаковый бит = 1)**
Учтем данное условие выражением (A[31] ) ̅&(B[31]) ̅&S[31]
**Когда A < 0 (знаковый бит = 1), B < 0 (знаковый бит = 1), S > 0 (знаковый бит = 0)**
Учтем данное условие выражением A[31]&B[31]&(S[31]]) ̅
**В итоге, получим выражение для знакового сравнения:**
comp_(zn A<B)=A[31]&(B[31] ) ̅  | (A[31] ) ̅&(B[31] ) ̅&S[31]  |  A[31]&B[31]&S[31] 
