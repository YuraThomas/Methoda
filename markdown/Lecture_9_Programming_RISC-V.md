...
>
> 00001<sub>2</sub>− регистр, с которым складываем константу
>
> 000000001000<sub>2</sub> = 8 − константа
...
> 00001<sub>2</sub>− регистр, с которым складываем константу
>
> 000000001001<sub>2</sub> = 9 − константа
...
> 00001<sub>2</sub>− регистр, с которым складываем константу
>
> 000000000000<sub>2</sub> = 0 − константа
...
> 00001<sub>2</sub> − регистр, с которым складываем константу
>
> 111111110001<sub>2</sub> = −15 − константа
...
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00000<sub>2</sub>− регистр, с которым складываем константу
>
> 000000000011<sub>2</sub> = 3 − константа
...
>
> 00001<sub>2</sub> = 1 − регистр, в который мы записываем результат операции на АЛУ
>
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00010<sub>2</sub>− регистр, с которым проводим операцию на АЛУ(RA1)
>
> 00001<sub>2</sub> = 1 − регистр, с которым проводим операцию на АЛУ(RA2)
>
> 0000000<sub>2</sub> = 0 − func7
...
>
> 00000 = номер регистра RA2 (всегда 0)
>
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00010<sub>2</sub>− номер регистра RA1 (счетчик)
>
> 0000000010000<sub>2</sub> = прыгаем на 4 строчки вниз (на 16 байт)
...
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00010− регистр, с которым складываем константу
>
> 111111111111<sub>2</sub> = −1 − константа
...
> 0010011<sub>2</sub> = 19 − opcode данного типа команды
>
> 00010 = 2 − регистр, в который мы записываем результат операции на АЛУ
>
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00010<sub>2</sub>− регистр, с которым складываем константу
>
> 000000000000<sub>2</sub> = 0 − константа
...
> 1100011<sub>2</sub> = 99 − opcode данного типа команды (B)
>
> 00010 = номер регистра RA2 (счетчик)
>
> 100<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00000<sub>2</sub>− номер регистра RA1 (ноль)
>
> 11111111110000<sub>2</sub> = прибавляем к счетчику -4, если условие верно
...
> 0010011<sub>2</sub> = 19 − opcode данного типа команды
>
> 00001 = 1 − регистр, в который мы записываем результат операции на АЛУ
>
> 000<sub>2</sub> − func3, показывает номер операции на АЛУ
>
> 00001<sub>2</sub>− регистр, с которым складываем константу
