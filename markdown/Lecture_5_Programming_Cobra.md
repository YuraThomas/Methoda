...
>
> 1 − Разрешаем запись в регистровый файл
...
> 
> 00001000<sub>2</sub> = 8 = константа, которую мы загружаем
>
...
> 
> 10<sub>2</sub> = 2 − на вход регистрового файла поается результат операции на АЛУ
>
> 0000<sub>2</sub> = 0 − номер операции на АЛУ
>
> 00001<sub>2</sub> = 1 − с этой ячейки памяти берем RA2
>
> 00010<sub>2</sub> = 2 − с этой ячейки памяти берем RA1
>
> 00011<sub>2</sub> = 3 − регистр, в который мы записываем результат операции на АЛУ
>
> 1 − разрешаем запись в регистровый файл
...
00011<sub>2</sub> = 3 − выводим значение с 3 ячейки, так-как туда записали результат операции на АЛУ 
...
> 
> 00100000<sub>2</sub> = 32 = константа, которую загружаем
>
> 00001<sub>2</sub> = 1 − регистр, в который записываем константу
>
> 1 − разрешаем запись в регистровый файл
...
> 
> 01000000<sub>2</sub> = 64 = константа, которую загружаем
>
> 00010<sub>2</sub> = 2 − регистр, в который записываем константу
>
> 1 − разрешаем запись в регистровый файл
> 
...
> 
> 10<sub>2</sub> = 2 − на вход регистрового файла подается результат операции на АЛУ
>
> 0001<sub>2</sub> = 1 − номер операции на АЛУ
>
> 00001<sub>2</sub> = 1 − с этой ячейки памяти берем RA2
>
> 00010<sub>2</sub> = 2 − с этой ячейки памяти берем RA1
...
00011<sub>2</sub> = 3 − выводим значение с 3 ячейки на выход 1 регистрового файла 
...
> 
> 00000111<sub>2</sub> = 7 = константа, которую загружаем
>
> 00001<sub>2</sub> = 1 − регистр, в который записываем константу
>
> 1 − разрешаем запись в регистровый файл
...
> 
> 00000011<sub>2</sub> = 3 = константа, которую загружаем
>
> 00010<sub>2</sub> = 2 − регистр, в который записываем константу
>
> 1 − разрешаем запись в регистровый файл
...
> 
> 00000001<sub>2</sub> = 1 = константа, которую загружаем
>
> 00100<sub>2</sub> = 4 − регистр, в который записываем константу
> 
> 1 − разрешаем запись в регистровый файл
...
> 0000<sub>2</sub> = 0 − номер операции на АЛУ
>
> 00011<sub>2</sub> = 3 − номер RA2
>
> 00001<sub>2</sub> = 1 − номер RA1
>
> 00011<sub>2</sub> = 3 − регистр, в который мы записываем результат операции на АЛУ
>
> 1 − разрешаем запись в регистровый файл
...
> 0001<sub>2</sub> = 1 − номер операции на АЛУ
>
> 00100<sub>2</sub> = 4 − номер RA2
>
> 00010<sub>2</sub> = 2 − номер RA1
> 
> 00010<sub>2</sub> = 2 − регистр, в который мы записываем результат операции на АЛУ
>
> 1 − разрешаем запись в регистровый файл
...
00011<sub>2</sub> = 3 − выводим значение с 3 ячейки (аналог print)
...
> 
> 11111101<sub>2</sub>=  − 3 − что прибавится к PC, если условие верно
>
> 1100<sub>2</sub> = 12 − номер операции на АЛУ (проверяем A < B)
>
> 00000<sub>2</sub> = 0 − с этой ячейки берем A
>
> 00010<sub>2</sub> = 2 − с этой ячейки берем B (значение счетчика)
>
> 1 − операция условного перехода
...
> 
> 00001<sub>2</sub> = 1 − регистр, в который мы записываем значение
>
> 01<sub>2</sub> = 1 − показывает, что запись будет с SW
>
> 1 − разрешаем запись в регистровый файл
...
> 
> 00010<sub>2</sub> = 2 − регистр, в который мы записываем значение
>
> 01<sub>2</sub> = 1 − показывает, что запись будет с SW
>
> 1 − разрешаем запись в регистровый файл
